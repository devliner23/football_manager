...
const MODIFIER_TO_TRAIT = {
  threePoint:         'three_point_scoring',
  midRange:           'mid_range_scoring',
...
const TRAIT_KEYS = [
  'three_point_scoring', 'mid_range_scoring', 'inside_scoring', 'passing',
  'ball_handling', 'perimeter_defense', 'post_defense',
  'rebounding', 'speed', 'strength',
];

const OVERALL_WEIGHTS = {
  three_point_scoring: 0.08,
  mid_range_scoring:   0.07,
  inside_scoring:      0.12,
  passing:             0.10,
  ball_handling:       0.10,
...
class TeamArchetypeService {
  ...
  static recalculateOverall(traits, position) {
    const posOverrides = {
      ...
      SG: { three_point_scoring: 0.12,   mid_range_scoring: 0.10, perimeter_defense: 0.12 },
