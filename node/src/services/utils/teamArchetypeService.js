...
const TEAM_ARCHETYPES = {
  '3-and-D': {
    ...
    icon:        '🎯',
    positionModifiers: {
      PG: { threePoint: 8,  perimeterDefense: 6,  inside_scoring: -5 },
      SG: { threePoint: 10, perimeterDefense: 8,  inside_scoring: -6 },
      SF: { threePoint: 8,  perimeterDefense: 8,  inside_scoring: -4 },
      PF: { threePoint: 6,  perimeterDefense: 6,  inside_scoring: -2 },
      C:  { threePoint: 4,  perimeterDefense: 4,  inside_scoring: -2 },
    },
  ...
  'post-heavy': {
    ...
    icon:        '🏋️',
    positionModifiers: {
      PG: { inside_scoring:  -2, passing: -2, rebounding:  2 },
      SG: { inside_scoring:   0, passing: -3, rebounding:  3 },
      SF: { inside_scoring:   3, passing: -2, rebounding:  4 },
      PF: { inside_scoring:   8, postDefense: 8, rebounding: 10, threePoint: -8 },
      C:  { inside_scoring:  10, postDefense: 10, rebounding: 12, threePoint: -10 },
    },
    positionWeights: { PG: 2, SG: 2, SF: 3, PF: 4, C: 4 },
    talentCurve: { mean: 58, stdDev: 12 },
    mininside_scoring: 40,
    minRebounding:    35,
  },
  ...
  'small-ball': {
    ...
    icon:        '⚡',
    positionModifiers: {
      PG: { speed: 8,  ball_handling: 6, threePoint: 4 },
      SG: { speed: 10, ball_handling: 5, threePoint: 6 },
      SF: { speed: 8,  ball_handling: 4, threePoint: 6, rebounding: -4 },
      PF: { speed: 6,  ball_handling: 3, threePoint: 4, rebounding: -8, postDefense: -6 },
      C:  { speed: 4,  ball_handling: 2, threePoint: 3, rebounding: -10, postDefense: -8 },
    },
  ...
  'defensive-minded': {
    ...
    positionModifiers: {
      ...
      PF: { postDefense: 10, perimeterDefense: 4,  inside_scoring: -2 },
      C:  { postDefense: 12, perimeterDefense: 2,  inside_scoring: -2 },
    },
  ...
  'run-and-gun': {
    ...
    icon:        '🏃',
    positionModifiers: {
      PG: { speed: 10, ball_handling: 8, passing: 6, threePoint: 4 },
      SG: { speed: 10, ball_handling: 6, passing: 4, threePoint: 6 },
      SF: { speed: 8,  ball_handling: 4, passing: 3, threePoint: 4 },
      PF: { speed: 6,  ball_handling: 2, passing: 2, threePoint: 2 },
      C:  { speed: 4,  ball_handling: 1, passing: 1 },
    },
  ...
  'inside-out': {
    ...
    icon:        '🔄',
    positionModifiers: {
      PG: { threePoint: 4,  ball_handling: 4,   inside_scoring: -2 },
      SG: { threePoint: 4,  midRange: 4,        inside_scoring: -2 },
      SF: { threePoint: 3,  midRange: 3,        inside_scoring:  2 },
      PF: { threePoint: 2,  midRange: 2,        inside_scoring:  6, postDefense: 4 },
      C:  { threePoint: 1,  midRange: 1,        inside_scoring:  8, postDefense: 6 },
    },
    positionWeights: { PG: 3, SG: 3, SF: 3, PF: 3, C: 3 },
  ...
  'youth-movement': {
    ...
    icon:        '🌟',
    positionModifiers: {
      PG: { speed: 6,  ball_handling: 4, threePoint: 2 },
      SG: { speed: 6,  ball_handling: 3, threePoint: 3 },
      SF: { speed: 6,  ball_handling: 2, threePoint: 2 },
      PF: { speed: 4,  ball_handling: 2, threePoint: 1 },
      C:  { speed: 3,  ball_handling: 1, threePoint: 1 },
    },
    positionWeights: { PG: 3, SG: 3, SF: 3, PF: 3, C: 3 },
  ...
  'veteran-leadership': {
    ...
    icon:        '👴',
    positionModifiers: {
      PG: { passing: 6,  ball_handling: 4, threePoint: 2, speed: -4 },
      SG: { passing: 4,  ball_handling: 3, threePoint: 3, speed: -4 },
      SF: { passing: 3,  ball_handling: 2, threePoint: 2, speed: -4 },
      PF: { passing: 2,  ball_handling: 1, threePoint: 1, speed: -4 },
      C:  { passing: 2,  ball_handling: 1, threePoint: 1, speed: -4 },
    },
    positionWeights: { PG: 3, SG: 3, SF: 3, PF: 3, C: 3 },
  ...
  'pace-and-space': {
    ...
    icon:        '🌌',
    positionModifiers: {
      PG: { threePoint: 6,  passing: 6, ball_handling: 4, inside_scoring: -4 },
      SG: { threePoint: 8,  passing: 4, ball_handling: 3, inside_scoring: -5 },
      SF: { threePoint: 6,  passing: 3, ball_handling: 2, inside_scoring: -3 },
      PF: { threePoint: 5,  passing: 2, ball_handling: 1, inside_scoring: -3, rebounding: -3 },
      C:  { threePoint: 4,  passing: 2, ball_handling: 1, inside_scoring: -2, rebounding: -3 },
    },
  ...
  'positionless': {
    ...
    icon:        '♾️',
    positionModifiers: {
      PG: { perimeterDefense: 4, ball_handling: 2, heightBoost: 4 },
      SG: { perimeterDefense: 4, ball_handling: 2, heightBoost: 3 },
      SF: { perimeterDefense: 3, ball_handling: 2, heightBoost: 2 },
      PF: { perimeterDefense: 3, ball_handling: 1, heightBoost: 2 },
      C:  { perimeterDefense: 2, ball_handling: 1, heightBoost: 1 },
    },
...
class TeamArchetypeService {
  ...
  static _getArchetypeStrengths(archetype) {
    ...
    if (archetype.mininside_scoring)    strengths.push('Inside Scoring');
